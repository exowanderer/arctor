...
y_center = wasp43.trace_ycenters[42]
x_left = wasp43.x_left
x_right = wasp43.x_right
trace_width = x_right - x_left

aper_tilt = RectangularAperture(positions[42], trace_width, 2, thetas[42])
aper_flat = RectangularAperture(positions[42], trace_width, 2, 0)
